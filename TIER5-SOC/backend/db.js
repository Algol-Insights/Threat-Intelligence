...
function migrate() {
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS events (
      ...
      ioc_hit TEXT,
      cdpa_relevant INTEGER DEFAULT 0,
      cdpa_classification TEXT,
      cdpa_risk_score INTEGER DEFAULT 0,
      enrichment TEXT,
      created_at TEXT DEFAULT (datetime('now'))
    );
    ...
    CREATE INDEX IF NOT EXISTS idx_ueba_created ON ueba_anomalies(created_at DESC);
    ...
    CREATE INDEX IF NOT EXISTS idx_honeypot_created ON honeypot_events(created_at DESC);
    ...
    CREATE TABLE IF NOT EXISTS hunt_hypotheses (
      ...
      status TEXT DEFAULT 'open' CHECK(status IN ('open','investigating','confirmed','dismissed')),
      findings TEXT,
      created_by TEXT,
      created_at TEXT DEFAULT (datetime('now')),
      updated_at TEXT DEFAULT (datetime('now'))
